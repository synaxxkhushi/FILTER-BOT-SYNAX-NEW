...
PICS = (environ.get('PICS', 'https://graph.org/file/5e52f83961ef37a6be6de.jpg')).split()
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/N8f.jpg') # payment code picture url.
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/synaxbots')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'synaxchatgroup') # Supsynaxnetworkport Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/verifiedsarthak')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://agricultural-danica-hhhhffhxxxxxxyyy-c43b6f69.koyeb.app/")
